...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_Q2_0    = 42,
        GGML_TYPE_TURBO2_0 = 47, // TurboQuant 2-bit KV cache: WHT + 2-bit PolarQuant
        GGML_TYPE_TURBO3_0 = 48, // TurboQuant 3-bit KV cache: WHT + 3-bit PolarQuant
        GGML_TYPE_TURBO4_0 = 49, // TurboQuant 4-bit KV cache: WHT + 4-bit PolarQuant
