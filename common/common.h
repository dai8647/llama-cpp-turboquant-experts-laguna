...
struct common_params {
    ...
    bool    moe_gpu_expert_global_lru = false; // --moe-gpu-expert-global-lru: FreeToken-style hot-expert LRU paging
    bool    moe_hot_expert = false; // --moe-hot-expert: enable cpu-moe + auto slots + global LRU in one flag
